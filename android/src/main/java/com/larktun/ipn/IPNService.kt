...
open class IPNService : VpnService(), libtailscale.IPNService {
  ...
  companion object {
    const val ACTION_START_VPN = "com.larktun.ipn.START_VPN"
    const val ACTION_STOP_VPN = "com.larktun.ipn.STOP_VPN"
    const val ACTION_RESTART_VPN = "com.larktun.ipn.RESTART_VPN"
  }
}
