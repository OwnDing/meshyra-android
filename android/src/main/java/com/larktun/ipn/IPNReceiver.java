...
public class IPNReceiver extends BroadcastReceiver {
    ...
    public static final String INTENT_CONNECT_VPN = "com.larktun.ipn.CONNECT_VPN";
    public static final String INTENT_DISCONNECT_VPN = "com.larktun.ipn.DISCONNECT_VPN";

    private static final String INTENT_USE_EXIT_NODE = "com.larktun.ipn.USE_EXIT_NODE";
