...
object Links {
  ...
  const val SETTINGS_ADMIN_URL = "https://larktun.com/auth/login"
  const val SIGNIN_URL = "https://tailscale.com/login"
  const val PRIVACY_POLICY_URL = "https://larktun.com/legal/privacy-policy"
  const val TERMS_URL = "https://larktun.com/legal/terms-of-service"
